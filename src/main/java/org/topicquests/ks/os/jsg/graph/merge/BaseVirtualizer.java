...
import org.topicquests.ks.os.jsg.JSGEnvironment;
import org.topicquests.ks.os.jsg.api.IExtendedCoreOntology;
import org.topicquests.ks.os.jsg.graph.api.IDataProvider;
import org.topicquests.ks.os.jsg.graph.api.IProxy;
import org.topicquests.ks.os.jsg.graph.api.IProxyModel;
import org.topicquests.ks.os.jsg.graph.api.ITuple;
...
public class BaseVirtualizer {
  protected JSGEnvironment environment;
  ...
  public void init(JSGEnvironment env) {
    environment = env;
